...
<div class="page-content p-5 shadow-sm " id="content">
    <div class=" mt-5 text-center">
        <!--Table-->
        <p class=" bg-primary rounded text-white p-2">List of Employees</p>
    <?php
...
<div>
    <a class="btn btn-primary float-right box" href="addstaff.php">
