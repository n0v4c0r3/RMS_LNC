...
if(isset($_REQUEST['psubmit'])){
 ...
 if(($_REQUEST['pname'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "")  || ($_REQUEST['poriginalcost'] == "") )
 {
  ...
  $poriginalcost = $_REQUEST['poriginalcost'];
   ...
   $sql = "INSERT INTO menu_tb (pname, pdop, pava, poriginalcost) VALUES ('$pname', '$pdop','$pava', '$poriginalcost')";
...
<div class="page-content p-5 mt-5" id="content">
  ...
  <form action="" method="POST">
    ...
    <div class="form-group">
      <label for="pdop">Date of Addition</label>
      <input type="date" class="form-control" id="pdop" name="pdop">
    </div>
    <div class="form-group">
      <label for="pava">Item Available</label>
